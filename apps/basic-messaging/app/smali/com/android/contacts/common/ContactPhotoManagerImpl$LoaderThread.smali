...
.method private loadPhotosInBackground()V
    ...
    .line 1147
    invoke-static {v0}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$fgetmContext(Lcom/android/contacts/common/ContactPhotoManagerImpl;)Landroid/content/Context;
    ...
    .line 1150
    invoke-static {v0, v1, v2, v3}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$mobtainPhotoIdsAndUrisToLoad(Lcom/android/contacts/common/ContactPhotoManagerImpl;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;)V
...
.method private loadThumbnails(Z)V
    ...
    invoke-static {}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$sfgetCOLUMNS()[Ljava/lang/String;
    ...
    invoke-static {}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$sfgetEMPTY_STRING_ARRAY()[Ljava/lang/String;
    ...
    .line 1205
    invoke-static {v8, v6, v7, p1, v5}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$mcacheBitmap(Lcom/android/contacts/common/ContactPhotoManagerImpl;Ljava/lang/Object;[BZI)V
    ...
    invoke-static {v6, v8, v9, p1, v5}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$mcacheBitmap(Lcom/android/contacts/common/ContactPhotoManagerImpl;Ljava/lang/Object;[BZI)V
    ...
    .line 1227
    invoke-static {v8, v6, v2, p1, v5}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$mcacheBitmap(Lcom/android/contacts/common/ContactPhotoManagerImpl;Ljava/lang/Object;[BZI)V
    :try_end_3
    ...
    .line 1236
    invoke-static {v7, v6, v2, p1, v5}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$mcacheBitmap(Lcom/android/contacts/common/ContactPhotoManagerImpl;Ljava/lang/Object;[BZI)V
    ...
    .line 1240
    invoke-static {p1}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$fgetmMainThreadHandler(Lcom/android/contacts/common/ContactPhotoManagerImpl;)Landroid/os/Handler;
...
.method private loadUriBasedPhotos()V
    ...
    .line 1274
    invoke-static {v9}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$fgetmUserAgent(Lcom/android/contacts/common/ContactPhotoManagerImpl;)Ljava/lang/String;
    ...
    .line 1275
    invoke-static {v10}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$fgetmUserAgent(Lcom/android/contacts/common/ContactPhotoManagerImpl;)Ljava/lang/String;
    ...
    .line 1292
    invoke-virtual {v9, v11, v7, v10}, Ljava/io/ByteArrayOutputStream;->write([BII)V
    :try_end_3
    ...
    invoke-static {v8, v4, v9, v7, v10}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$mcacheBitmap(Lcom/android/contacts/common/ContactPhotoManagerImpl;Ljava/lang/Object;[BZI)V

    iget-object v8, p0, Lcom/android/contacts/common/ContactPhotoManagerImpl$LoaderThread;->this$0:Lcom/android/contacts/common/ContactPhotoManagerImpl;

    .line 1298
    invoke-static {v8}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$fgetmMainThreadHandler(Lcom/android/contacts/common/ContactPhotoManagerImpl;)Landroid/os/Handler;
    ...
    invoke-static {v1, v8, v9}, Lcom/android/dialer/common/LogUtil;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v8, v4, v6, v7, v9}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$mcacheBitmap(Lcom/android/contacts/common/ContactPhotoManagerImpl;Ljava/lang/Object;[BZI)V
    :try_end_4
    ...
    invoke-static {v1, v5, v8}, Lcom/android/dialer/common/LogUtil;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v5, v4, v6, v7, v3}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$mcacheBitmap(Lcom/android/contacts/common/ContactPhotoManagerImpl;Ljava/lang/Object;[BZI)V
...
.method private preloadPhotosInBackground()V
    ...
    .line 1079
    invoke-static {v0}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$fgetmBitmapHolderCache(Lcom/android/contacts/common/ContactPhotoManagerImpl;)Landroid/util/LruCache;
    ...
    invoke-static {v3}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$fgetmBitmapHolderCacheRedZoneBytes(Lcom/android/contacts/common/ContactPhotoManagerImpl;)I
    ...
    invoke-static {v1}, Lcom/android/contacts/common/ContactPhotoManagerImpl;->-$$Nest$fgetmBitmapHolderCache(Lcom/android/contacts/common/ContactPhotoManagerImpl;)Landroid/util/LruCache;
...
.method private queryPhotosForPreload()V
    ...
    const-string/jumbo v7, "starred DESC, last_time_contacted DESC"
