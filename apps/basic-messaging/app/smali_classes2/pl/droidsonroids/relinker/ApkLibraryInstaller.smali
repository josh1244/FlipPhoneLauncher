...
.method private findAPKWithLibrary(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Lpl/droidsonroids/relinker/ReLinkerInstance;)Lpl/droidsonroids/relinker/ApkLibraryInstaller$ZipFileInZipEntry;
    ...
    invoke-virtual {v4, v14, v15}, Lpl/droidsonroids/relinker/ReLinkerInstance;->log(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v6, v12}, Lpl/droidsonroids/relinker/ApkLibraryInstaller$ZipFileInZipEntry;-><init>(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;)V
...
.method public installLibrary(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Ljava/io/File;Lpl/droidsonroids/relinker/ReLinkerInstance;)V
    ...
    invoke-virtual {p5, v1, v3}, Lpl/droidsonroids/relinker/ReLinkerInstance;->log(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
    ...
    iget-object v3, p1, Lpl/droidsonroids/relinker/ApkLibraryInstaller$ZipFileInZipEntry;->zipEntry:Ljava/util/zip/ZipEntry;
    ...
    .line 148
    :try_start_5
    invoke-direct {p0, v1, v3}, Lpl/droidsonroids/relinker/ApkLibraryInstaller;->copy(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    .line 166
    invoke-virtual {p4, p3, p2}, Ljava/io/File;->setReadable(ZZ)Z

    .line 167
    invoke-virtual {p4, p3, p2}, Ljava/io/File;->setExecutable(ZZ)Z

    .line 168
    invoke-virtual {p4, p3}, Ljava/io/File;->setWritable(Z)Z
    :try_end_6
