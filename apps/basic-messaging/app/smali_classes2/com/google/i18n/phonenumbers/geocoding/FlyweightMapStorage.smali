...
.method private createDescriptionPool(Ljava/util/SortedSet;Ljava/util/SortedMap;)V
    ...
    invoke-static {v0}, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->getOptimalNumberOfBytesForValue(I)I

    move-result v0

    iput v0, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->descIndexSizeInBytes:I

    .line 95
    iget v0, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->numOfEntries:I
    ...
    iput-object v0, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->descriptionIndexes:Ljava/nio/ByteBuffer;
    ...
    iput-object v0, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->descriptionPool:[Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->descriptionPool:[Ljava/lang/String;
    ...
    iget v3, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->descIndexSizeInBytes:I

    .line 105
    invoke-static {v2, v3, v0, v1}, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->storeWordInBuffer(Ljava/nio/ByteBuffer;III)V
...
.method private readEntries(Ljava/io/ObjectInput;)V
    ...
    iput v0, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->numOfEntries:I
    ...
    iput-object v0, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->phoneNumberPrefixes:Ljava/nio/ByteBuffer;

    :cond_1
    iget-object v0, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->descriptionIndexes:Ljava/nio/ByteBuffer;
...
.method public readExternal(Ljava/io/ObjectInput;)V
    ...
    iput v0, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->prefixSizeInBytes:I
    ...
    .line 118
    iget-object v1, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->possibleLengths:Ljava/util/TreeSet;
    ...
    .line 120
    iget-object v3, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->possibleLengths:Ljava/util/TreeSet;
    ...
    iput-object v2, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->descriptionPool:[Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->descriptionPool:[Ljava/lang/String;
...
.method public readFromSortedMap(Ljava/util/SortedMap;)V
    ...
    invoke-static {v1}, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->getOptimalNumberOfBytesForValue(I)I

    move-result v1

    iput v1, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->prefixSizeInBytes:I
    ...
    iget-object v5, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->phoneNumberPrefixes:Ljava/nio/ByteBuffer;

    iget v6, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->prefixSizeInBytes:I

    .line 81
    invoke-static {v5, v6, v2, v4}, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->storeWordInBuffer(Ljava/nio/ByteBuffer;III)V

    .line 82
    iget-object v5, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->possibleLengths:Ljava/util/TreeSet;
    ...
    .line 86
    :cond_0
    invoke-direct {p0, v0, p1}, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->createDescriptionPool(Ljava/util/SortedSet;Ljava/util/SortedMap;)V
...
.method public writeExternal(Ljava/io/ObjectOutput;)V
    ...
    iget v0, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->prefixSizeInBytes:I

    .line 157
    invoke-interface {p1, v0}, Ljava/io/ObjectOutput;->writeInt(I)V

    iget v0, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->descIndexSizeInBytes:I

    .line 158
    invoke-interface {p1, v0}, Ljava/io/ObjectOutput;->writeInt(I)V

    .line 161
    iget-object v0, p0, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->possibleLengths:Ljava/util/TreeSet;
    ...
    .line 177
    invoke-static {p1, v0, v1, v2}, Lcom/google/i18n/phonenumbers/geocoding/FlyweightMapStorage;->writeExternalWord(Ljava/io/ObjectOutput;ILjava/nio/ByteBuffer;I)V
