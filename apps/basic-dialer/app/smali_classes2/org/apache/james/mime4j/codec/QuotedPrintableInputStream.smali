...
.method private read0([BII)I
    ...
    const-string v1, "Leaving it as is"

    const-string v2, "Found CR without LF"
    ...
    const-string v1, "Translating to CRLF"

    const-string v2, "Found LF without CR"
    ...
    .line 241
    invoke-virtual {v1, v14}, Lorg/apache/james/mime4j/util/ByteArrayBuffer;->append(I)V
    ...
    .line 247
    invoke-direct {v6, v14}, Lorg/apache/james/mime4j/codec/QuotedPrintableInputStream;->convert(I)I
    ...
    .line 259
    invoke-virtual {v0, v14}, Lorg/apache/james/mime4j/util/ByteArrayBuffer;->append(I)V
