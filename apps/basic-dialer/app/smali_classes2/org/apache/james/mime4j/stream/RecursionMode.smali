...
.method static constructor <clinit>()V
    ...
    const-string v2, "M_NO_RECURSE"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lorg/apache/james/mime4j/stream/RecursionMode;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lorg/apache/james/mime4j/stream/RecursionMode;->M_NO_RECURSE:Lorg/apache/james/mime4j/stream/RecursionMode;

    .line 38
    new-instance v2, Lorg/apache/james/mime4j/stream/RecursionMode;

    const-string v3, "M_RAW"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lorg/apache/james/mime4j/stream/RecursionMode;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lorg/apache/james/mime4j/stream/RecursionMode;->M_RAW:Lorg/apache/james/mime4j/stream/RecursionMode;

    .line 43
    new-instance v3, Lorg/apache/james/mime4j/stream/RecursionMode;

    const-string v4, "M_FLAT"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lorg/apache/james/mime4j/stream/RecursionMode;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lorg/apache/james/mime4j/stream/RecursionMode;->M_FLAT:Lorg/apache/james/mime4j/stream/RecursionMode;

    filled-new-array {v0, v1, v2, v3}, [Lorg/apache/james/mime4j/stream/RecursionMode;
