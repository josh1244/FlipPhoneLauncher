...
.method private startProvisionNewUser(Lcom/android/voicemail/impl/ActivationTask;Landroid/telecom/PhoneAccountHandle;Lcom/android/voicemail/impl/OmtpVvmCarrierConfigHelper;Lcom/android/voicemail/impl/VoicemailStatus$Editor;Lcom/android/voicemail/impl/sms/StatusMessage;)V
    ...
    .line 218
    :try_start_2
    new-instance v3, Lcom/android/voicemail/impl/imap/ImapHelper;
    ...
    invoke-direct {v3, v4, p2, v2, p4}, Lcom/android/voicemail/impl/imap/ImapHelper;-><init>(Landroid/content/Context;Landroid/telecom/PhoneAccountHandle;Landroid/net/Network;Lcom/android/voicemail/impl/VoicemailStatus$Editor;)V
    :try_end_2
    ...
    .line 225
    invoke-virtual {v3, v2}, Lcom/android/voicemail/impl/imap/ImapHelper;->changeVoicemailTuiLanguage(Ljava/lang/String;)V
    ...
    :goto_0
    const-string v2, "new user: language set"
    ...
    invoke-static {v2, p2, v3, p5}, Lcom/android/voicemail/impl/protocol/Vvm3Protocol;->setPin(Landroid/content/Context;Landroid/telecom/PhoneAccountHandle;Lcom/android/voicemail/impl/imap/ImapHelper;Lcom/android/voicemail/impl/sms/StatusMessage;)Z
    ...
    .line 234
    invoke-virtual {v3}, Lcom/android/voicemail/impl/imap/ImapHelper;->closeNewUserTutorial()V
    ...
    :cond_1
    :try_start_4
    invoke-virtual {v3}, Lcom/android/voicemail/impl/imap/ImapHelper;->close()V
    :try_end_4
    ...
    throw p2
    :try_end_6
    .catch Lcom/android/voicemail/impl/imap/ImapHelper$InitializingException; {:try_start_6 .. :try_end_6} :catch_2
    .catch Lcom/android/voicemail/impl/mail/MessagingException; {:try_start_6 .. :try_end_6} :catch_1
    ...
    :try_end_8
    .catch Lcom/android/voicemail/impl/sync/VvmNetworkRequest$RequestFailedException; {:try_start_8 .. :try_end_8} :catch_3
    ...
    throw p2
    :try_end_a
    .catch Lcom/android/voicemail/impl/sync/VvmNetworkRequest$RequestFailedException; {:try_start_a .. :try_end_a} :catch_3
...
.method public getCommand(Ljava/lang/String;)Ljava/lang/String;
    ...
    :sswitch_data_0
    .sparse-switch
        -0x7d5784d2 -> :sswitch_2
        -0x170ff158 -> :sswitch_1
        -0xc1b2497 -> :sswitch_0
    .end sparse-switch
...
.method public startProvisioning(Lcom/android/voicemail/impl/ActivationTask;Landroid/telecom/PhoneAccountHandle;Lcom/android/voicemail/impl/OmtpVvmCarrierConfigHelper;Lcom/android/voicemail/impl/VoicemailStatus$Editor;Lcom/android/voicemail/impl/sms/StatusMessage;Landroid/os/Bundle;)V
    ...
    const-string v0, "start vvm3 provisioning"
    ...
    .line 122
    invoke-static {v0, v2}, Lcom/android/voicemail/impl/utils/LoggerUtils;->logImpressionOnMainThread(Landroid/content/Context;Lcom/android/dialer/logging/DialerImpression$Type;)V
    ...
    const-string v0, "Provisioning status: Unknown"
    ...
    .line 127
    invoke-static {v1, p5}, Lcom/android/voicemail/impl/VvmLog;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/voicemail/impl/protocol/Vvm3Subscriber;-><init>(Lcom/android/voicemail/impl/ActivationTask;Landroid/telecom/PhoneAccountHandle;Lcom/android/voicemail/impl/OmtpVvmCarrierConfigHelper;Lcom/android/voicemail/impl/VoicemailStatus$Editor;Landroid/os/Bundle;)V
    ...
    .line 133
    invoke-static {v1, p6}, Lcom/android/voicemail/impl/VvmLog;->i(Ljava/lang/String;Ljava/lang/String;)V
