...
# direct methods
.method public static synthetic $r8$lambda$lqK4OWuhqvpkxtQ9AixRlG1DQz0()Ljava/util/Locale;
    .locals 1
...
.method static bridge synthetic -$$Nest$fgetgeocoder(Lcom/android/dialer/location/CountryDetector;)Landroid/location/Geocoder;
    .locals 0
...
.method static bridge synthetic -$$Nest$smprocessLocationUpdate(Landroid/content/Context;Landroid/location/Geocoder;Landroid/location/Location;)V
    .locals 0
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/android/dialer/location/CountryDetector;
    ...
    new-instance v6, Lcom/android/dialer/location/CountryDetector$$ExternalSyntheticLambda2;

    invoke-direct {v6}, Lcom/android/dialer/location/CountryDetector$$ExternalSyntheticLambda2;-><init>()V
...
.method static synthetic lambda$processLocationUpdate$0(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string v0, "preference_time_updated"
...
.method static synthetic lambda$processLocationUpdate$1(Ljava/lang/Throwable;)V
    ...
    const-string v0, "exception occurred when getting geocoded country from location"
    ...
    const-string v1, "CountryDetector.processLocationUpdate"

    invoke-static {v1, v0, p0}, Lcom/android/dialer/common/LogUtil;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static processLocationUpdate(Landroid/content/Context;Landroid/location/Geocoder;Landroid/location/Location;)V
    ...
    .line 237
    new-instance v0, Lcom/android/dialer/location/CountryDetector$GeocodeCountryWorker;

    invoke-direct {v0, p1}, Lcom/android/dialer/location/CountryDetector$GeocodeCountryWorker;-><init>(Landroid/location/Geocoder;)V
    ...
    new-instance v0, Lcom/android/dialer/location/CountryDetector$$ExternalSyntheticLambda0;

    invoke-direct {v0, p0}, Lcom/android/dialer/location/CountryDetector$$ExternalSyntheticLambda0;-><init>(Landroid/content/Context;)V
    ...
    new-instance p1, Lcom/android/dialer/location/CountryDetector$$ExternalSyntheticLambda1;

    invoke-direct {p1}, Lcom/android/dialer/location/CountryDetector$$ExternalSyntheticLambda1;-><init>()V
...
.method private static registerForLocationUpdates(Landroid/content/Context;Landroid/location/LocationManager;)V
    ...
    const-string p0, "no location permissions, not registering for location updates"

    new-array p1, v2, [Ljava/lang/Object;

    .line 109
    invoke-static {v1, p0, p1}, Lcom/android/dialer/common/LogUtil;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
