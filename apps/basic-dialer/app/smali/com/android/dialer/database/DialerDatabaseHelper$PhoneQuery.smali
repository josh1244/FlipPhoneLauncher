...
.field public static final PHONE_INDEX_IN_SIM:I = 0xf
...
.method static constructor <clinit>()V
    ...
    const-string v0, "contact_last_updated_timestamp > ? AND length(lookup) < 1000"

    goto :goto_1

    :cond_1
    const-string v0, "contact_last_updated_timestamp > ? AND length(lookup) < 1000 AND index_in_sim == -1"

    :goto_1
    sput-object v0, Lcom/android/dialer/database/DialerDatabaseHelper$PhoneQuery;->SELECTION:Ljava/lang/String;
