...
.method synthetic constructor <init>(Lcom/android/contacts/common/model/AccountTypeManagerImpl;Lcom/android/contacts/common/model/AccountTypeManagerImpl$FindInvitablesTask-IA;)V
    .locals 0
...
.method protected varargs doInBackground([Ljava/lang/Void;)Ljava/util/Map;
    ...
    .line 807
    invoke-static {p1}, Lcom/android/contacts/common/model/AccountTypeManagerImpl;->-$$Nest$fgetmContext(Lcom/android/contacts/common/model/AccountTypeManagerImpl;)Landroid/content/Context;

    move-result-object v0

    invoke-static {p1, v0}, Lcom/android/contacts/common/model/AccountTypeManagerImpl;->-$$Nest$mfindUsableInvitableAccountTypes(Lcom/android/contacts/common/model/AccountTypeManagerImpl;Landroid/content/Context;)Ljava/util/Map;
...
.method protected onPostExecute(Ljava/util/Map;)V
    ...
    .line 812
    invoke-static {v0}, Lcom/android/contacts/common/model/AccountTypeManagerImpl;->-$$Nest$fgetmInvitableAccountTypeCache(Lcom/android/contacts/common/model/AccountTypeManagerImpl;)Lcom/android/contacts/common/model/AccountTypeManagerImpl$InvitableAccountTypeCache;
    ...
    .line 813
    invoke-static {p1}, Lcom/android/contacts/common/model/AccountTypeManagerImpl;->-$$Nest$fgetmInvitablesTaskIsRunning(Lcom/android/contacts/common/model/AccountTypeManagerImpl;)Ljava/util/concurrent/atomic/AtomicBoolean;
