...
.source "ChainingHtmlWriter.java"
...
.method private buildPage()Lezvcard/io/html/HCardPage;
    ...
    iget-object v1, p0, Lezvcard/io/chain/ChainingHtmlWriter;->template:Lfreemarker/template/Template;

    invoke-direct {v0, v1}, Lezvcard/io/html/HCardPage;-><init>(Lfreemarker/template/Template;)V

    .line 102
    :goto_0
    iget-object v1, p0, Lezvcard/io/chain/ChainingHtmlWriter;->vcards:Ljava/util/Collection;
...
.method public go(Ljava/nio/file/Path;)V
    ...
    invoke-virtual {v0, p1}, Lezvcard/io/html/HCardPage;->write(Ljava/nio/file/Path;)V
