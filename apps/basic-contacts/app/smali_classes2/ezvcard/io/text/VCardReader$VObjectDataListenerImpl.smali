...
.method private handleSkippedProperty(Ljava/lang/String;ILezvcard/io/SkipMeException;)V
    ...
    .line 345
    invoke-virtual {p3}, Lezvcard/io/SkipMeException;->getMessage()Ljava/lang/String;
    ...
    invoke-virtual {p2, v0, p3}, Lezvcard/io/ParseWarning$Builder;->message(I[Ljava/lang/Object;)Lezvcard/io/ParseWarning$Builder;
...
.method private handleUnparseableProperty(Ljava/lang/String;Lezvcard/parameter/VCardParameters;Ljava/lang/String;Lezvcard/VCardDataType;ILezvcard/VCardVersion;Lezvcard/io/CannotParseException;)Lezvcard/property/VCardProperty;
    ...
    .line 360
    invoke-virtual {p5, p3, p4, p2, p1}, Lezvcard/io/scribe/RawPropertyScribe;->parseText(Ljava/lang/String;Lezvcard/VCardDataType;Lezvcard/parameter/VCardParameters;Lezvcard/io/ParseContext;)Lezvcard/property/VCardProperty;
...
.method private handledEmbeddedVCard(Ljava/lang/String;Ljava/lang/String;ILezvcard/io/EmbeddedVCardException;)V
    ...
    .line 377
    :cond_0
    invoke-static {p2}, Lcom/github/mangstadt/vinnie/io/VObjectPropertyValues;->unescape(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p2, p1}, Lezvcard/io/text/VCardReader;->setScribeIndex(Lezvcard/io/scribe/ScribeIndex;)V

    .line 385
    :try_start_0
    invoke-virtual {p2}, Lezvcard/io/text/VCardReader;->readNext()Lezvcard/VCard;
    ...
    invoke-virtual {p2}, Lezvcard/io/text/VCardReader;->getWarnings()Ljava/util/List;
...
.method private parseProperty(Lcom/github/mangstadt/vinnie/VObjectProperty;Lezvcard/VCardVersion;I)Lezvcard/property/VCardProperty;
    ...
    invoke-virtual {v1}, Lcom/github/mangstadt/vinnie/VObjectParameters;->getMap()Ljava/util/Map;
...
.method private processNamelessParameters(Lezvcard/parameter/VCardParameters;)V
    ...
    .line 463
    invoke-virtual {p1, v0}, Lezvcard/parameter/VCardParameters;->removeAll(Ljava/lang/Object;)Ljava/util/List;
    ...
    .line 466
    invoke-virtual {p1, v2, v1}, Lezvcard/parameter/VCardParameters;->put(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public onComponentEnd(Ljava/lang/String;Lcom/github/mangstadt/vinnie/io/Context;)V
    ...
    .line 254
    invoke-virtual {p2}, Lcom/github/mangstadt/vinnie/io/Context;->stop()V
...
.method public onProperty(Lcom/github/mangstadt/vinnie/VObjectProperty;Lcom/github/mangstadt/vinnie/io/Context;)V
    ...
    .line 259
    invoke-virtual {p2}, Lcom/github/mangstadt/vinnie/io/Context;->getParentComponents()Ljava/util/List;
    ...
    .line 273
    invoke-virtual {p2}, Lcom/github/mangstadt/vinnie/io/Context;->getLineNumber()I
...
.method public onWarning(Lcom/github/mangstadt/vinnie/io/Warning;Lcom/github/mangstadt/vinnie/VObjectProperty;Ljava/lang/Exception;Lcom/github/mangstadt/vinnie/io/Context;)V
    ...
    .line 430
    invoke-virtual {p4}, Lcom/github/mangstadt/vinnie/io/Context;->getParentComponents()Ljava/util/List;
    ...
    .line 437
    invoke-virtual {p4}, Lcom/github/mangstadt/vinnie/io/Context;->getLineNumber()I
    ...
    .line 438
    :cond_1
    invoke-virtual {p2}, Lcom/github/mangstadt/vinnie/VObjectProperty;->getName()Ljava/lang/String;
    ...
    invoke-virtual {p4}, Lcom/github/mangstadt/vinnie/io/Context;->getUnfoldedLine()Ljava/lang/String;
    ...
    invoke-virtual {p2, p4, p1}, Lezvcard/io/ParseWarning$Builder;->message(I[Ljava/lang/Object;)Lezvcard/io/ParseWarning$Builder;
