...
.method protected static date(Ljava/time/temporal/Temporal;)Lezvcard/io/scribe/VCardPropertyScribe$DateWriter;
    .locals 1

    .line 573
    new-instance v0, Lezvcard/io/scribe/VCardPropertyScribe$DateWriter;

    invoke-direct {v0, p0}, Lezvcard/io/scribe/VCardPropertyScribe$DateWriter;-><init>(Ljava/time/temporal/Temporal;)V

    return-object v0
.end method

.method protected static date(Ljava/lang/String;)Ljava/time/temporal/Temporal;
    .locals 0

    .line 564
    invoke-static {p0}, Lezvcard/util/VCardDateFormat;->parse(Ljava/lang/String;)Ljava/time/temporal/Temporal;
...
.method protected static escape(Ljava/lang/String;Lezvcard/io/text/WriteContext;)Ljava/lang/String;
    ...
    .line 714
    :cond_0
    invoke-static {p0}, Lcom/github/mangstadt/vinnie/io/VObjectPropertyValues;->escape(Ljava/lang/String;)Ljava/lang/String;
...
.method protected static handlePrefParam(Lezvcard/property/VCardProperty;Lezvcard/parameter/VCardParameters;Lezvcard/VCardVersion;Lezvcard/VCard;)V
    ...
    .line 686
    invoke-virtual {p1, v2, p2}, Lezvcard/parameter/VCardParameters;->remove(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 679
    invoke-virtual {p1, v2, v0}, Lezvcard/parameter/VCardParameters;->put(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method private static jcardValueToString(Lezvcard/io/json/JCardValue;)Ljava/lang/String;
    ...
    .line 543
    invoke-static {v1}, Lcom/github/mangstadt/vinnie/io/VObjectPropertyValues;->writeList(Ljava/util/Collection;)Ljava/lang/String;
    ...
    .line 550
    invoke-static {v0, v2}, Lcom/github/mangstadt/vinnie/io/VObjectPropertyValues;->writeStructured(Ljava/util/List;Z)Ljava/lang/String;
...
.method protected static varargs missingXmlElements([Ljava/lang/String;)Lezvcard/io/CannotParseException;
    ...
    invoke-direct {v0, v1, p0}, Lezvcard/io/CannotParseException;-><init>(I[Ljava/lang/Object;)V
...
.method protected _parseHtml(Lezvcard/io/html/HCardElement;Lezvcard/io/ParseContext;)Lezvcard/property/VCardProperty;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected _parseJson(Lezvcard/io/json/JCardValue;Lezvcard/VCardDataType;Lezvcard/parameter/VCardParameters;Lezvcard/io/ParseContext;)Lezvcard/property/VCardProperty;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected abstract _parseText(Ljava/lang/String;Lezvcard/VCardDataType;Lezvcard/parameter/VCardParameters;Lezvcard/io/ParseContext;)Lezvcard/property/VCardProperty;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/String;",
...
.method protected _parseXml(Lezvcard/io/xml/XCardElement;Lezvcard/parameter/VCardParameters;Lezvcard/io/ParseContext;)Lezvcard/property/VCardProperty;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
