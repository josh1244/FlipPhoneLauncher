#!/usr/bin/env bash
# Rebuild basic-contacts from the decompiled source in app/, signed for in-place side-loading.
...
"$BT/apksigner" sign --ks "$KS" --ks-pass pass:android --key-pass pass:android \
  --out "$HERE/BasicContacts.apk" "$work/aligned.apk"
rm -rf "$work"
echo "built $HERE/BasicContacts.apk"
